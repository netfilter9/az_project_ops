# sap-ips
This role installs the ips software on a VM .

## Overview
The installation and configuration of IPS software involves a number of steps (at a high level):
...
|---|---|---|
|passwords.clusterkey|cluster key for IPS install|yes|
