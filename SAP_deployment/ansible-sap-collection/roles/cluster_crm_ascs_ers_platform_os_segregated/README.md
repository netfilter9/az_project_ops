# cluster_crm_ascs_ers_platform_os_segregated
This role performs the SAP software installation and cluster configuration for a new system install and has separate scripts and templates based on platform and os to be run as pilot before replacing the existing roles.
...
## Mofications on this role
1. Change the Linux system configuration 
2. Change the restart command to a start command for both sles and rhel
