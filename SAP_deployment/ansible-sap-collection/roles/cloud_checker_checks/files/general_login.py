...
#                                                                      #
# Contact: g.n.singh@accenture.com                                     #
########################################################################
"""
import sys
        ...
        try:
            ...
            if operating_system.upper() == 'WINDOWS':
                ...
                if self.auth_type == 'ppk':
                    #print(self.hostname, self.username, pemfile_path)
            ...
            # output_dict = {}
            # output_dict.update({'Output':'Error'})
            # output_dict.update({'ErrorMessage':err})
